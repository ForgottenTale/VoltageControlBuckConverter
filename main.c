...
int main(void)
{
  ...
  MX_TIM2_Init();
  MX_TIM3_Init();
	//Starting timer 3 for the adc sampling at 1Khz
 ...
 void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc)
{
  ...
  htim2.Instance->CCR1 = PIDController_Update(&pid,setpoint,voltage);
}
...
float ReadDCVoltage25(float adc)
{
  ...
  float factor = 17.24;
  float vCC = 2.5;
  vOut = adc/ 3100 * vCC; // convert the value to the real voltage on the analog pin
  vIn = vOut * factor;
  return vIn;
}
void SystemClock_Config(void)
